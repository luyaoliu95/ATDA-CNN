...
def train(data_num):
    ...
    file = r'/home/liuluyao/data/IEMOCAP_leave_{}_data_mfcc.pkl'.format(data_num)
    # file = r'/home/liuluyao/1_data/MSP_leave_{}_data_16000.pkl'.format(data_num)
    # file = r'/home/liuluyao/1_data/MELD_data_{}.pkl'.format(data_num)
    ...
    for i in range(Epoch):
        ...
        for i in range(len(val_y)):
            ...
            out_emotion = model(x.unsqueeze(0).unsqueeze(1))
...
if __name__ == '__main__':
    ...
    results_file = r'/home/liuluyao/code_BLSTM/results/IEMOCAP_CNN.pkl'
