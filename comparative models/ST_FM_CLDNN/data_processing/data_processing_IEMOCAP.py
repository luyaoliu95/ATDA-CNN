...
def process_IEMOCAP(path, seed=987654, fixed_t=6, test_cluster=1, split_method='random', silence_delete=True, data_aug=False, feature_to_use='mfcc'):
    ...
    for n in range(test_cluster):
        ...
        save_path = '..\data\IEMOCAP_leave_' + str(n+1) + '_data.pkl'
...
if __name__ == '__main__':
    ...
    process_IEMOCAP(r'K:\IEMOCAP', test_cluster=5, split_method='random', silence_delete=True, data_aug=False, feature_to_use='mfcc')
