...
from network import ST_FM_CLDNN
...
def train(dataset, data_num):
    ...
    if dataset == 'IEMOCAP':
        file = r'/home/liuluyao/data/IEMOCAP_leave_{}_data_logmel.pkl'.format(str(data_num))
    elif dataset == 'MSP':
    ...
    for i in range(Epoch):
        ...
        for i in range(len(val_y)):
            ...
            out_emotion, out_gender, out_emotion_center, out_gender_center = model(x.unsqueeze(0).unsqueeze(1))
            #
...
if __name__ == '__main__':
    ...
    results_file = r'/home/liuluyao/TCAN/result/MELD_Joint_Loss.pkl'
