...
def train(dataset, data_num):
    ...
    model = model = Encoder(max_seq_len=260, f_dim=60, dim_per_head=60, num_heads=8, ffn_dim=2048, dropout_rate=0.1, num_layers=6)
...
if __name__ == '__main__':
    ...
    results_file = r'/home/liuluyao/comparison_results/MELD.pkl'
