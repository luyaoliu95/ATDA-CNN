...
class MACNN(nn.Module):
    def __init__(self, attention_heads=4, attention_hidden=64):
        ...
        self.integral_fc_emotion = nn.Linear(in_features=self.attention_hidden, out_features=4)
        self.integral_fc_emotion_center = nn.Linear(in_features=self.attention_hidden, out_features=4)
        self.integral_fc_sex = nn.Linear(in_features=self.attention_hidden, out_features=2)
        self.integral_fc_sex_center = nn.Linear(in_features=self.attention_hidden, out_features=2)
