...
def train(dataset, data_num, out_root):
    ...
    log_name = r'/home/liuluyao/loggings/train_{}.log'.format(dataset)
    logfile = log_name
    ...
    model = CNN(Center=False, Gender=False, DyRELU=False)
    ...
    for i in range(Epoch):
        ...
        for _,data in enumerate(train_loader):
            ...
            attn, out_emotion = model(x.unsqueeze(1))
            # , out_gender, out_emotion_center, out_gender_center
        ...
        for i in range(len(val_y)):
            ...
            out_a, out_emotion = model(x.unsqueeze(0).unsqueeze(0))
            # , out_gender, out_emotion_center, out_gender_center
