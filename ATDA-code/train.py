...
# setup_seed(0)
# setup_seed(999999)
def train(dataset, data_num, parameter, param_value, out_root,  atten=False, atten_method='matmul', atten_view=('t'),
                 c_scale_method='conv', t_scale_method='conv', f_scale_method='conv',
                 f_scale=3, t_scale=3, c_scale=3):
    print(dataset, data_num, parameter, param_value)
    setup_seed(987654)
    ...
    log_name = r'/home/liuluyao/loggings/train_{}_{}_{}_{}.log'.format(dataset, data_num, parameter, param_value)
    logfile = log_name
    ...
    if dataset == 'IEMOCAP':
        file = r'/home/liuluyao/data/IEMOCAP_leave_{}_data.pkl'.format(str(data_num+1))
    elif dataset == 'MSP':
        file = r'/home/liuluyao/data/MSP_leave_{}_data_16000.pkl'.format(str(data_num+1))
    elif dataset == 'MELD':
    ...
    print(atten)
    model = TAM_CNN(atten=atten, atten_method=atten_method, atten_view=atten_view,
                 c_scale_method=c_scale_method, t_scale_method=t_scale_method, f_scale_method=f_scale_method,
    ...
    result_file = os.path.join( out_root,'{}_{}_{}_{}_results.pkl'.format(dataset, data_num, parameter, param_value))
    results = {
        'WA':maxWA,
        'UA':maxUA,
        'Matrix':best_matrix
    ...
    parameters = {
        ...
        'atten_view':atten_view,
        'c_scale_method':c_scale_method,
        't_scale_method': t_scale_method,
        'f_scale_method': f_scale_method,
        'c_scale': c_scale,
        't_scale': t_scale,
        'f_scale':f_scale
    }
